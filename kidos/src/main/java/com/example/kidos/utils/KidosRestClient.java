...
public class KidosRestClient {
	...
	public String request(String url, String method, Map<String, Object> data) throws Exception {
		System.out.println("Calling "+method+" with url :"+url);
	...
	private static class doRequest extends AsyncTask<Void, JSONObject, String>{
		...
		private KidosRestClient rest;
		// Store context for dialogs
		private IKidosRestClientWrapper context = null;
		// Store error message
		...
		public doRequest(IKidosRestClientWrapper context, Map<String, Object> data, String method, String url){
			this.context = context;
			this.data = data;
			this.method = method;
			this.url = url;
			rest =new KidosRestClient();
		}
		...
		protected void onPostExecute(String data){
			...
			context.restCallBack(data);
		}
	}
	
	
	public static void sendRequest(IKidosRestClientWrapper context, Map<String, Object> data, String method, String url)
	{
		try {
			url=KidosConstants.NETWORK_URL+url;
